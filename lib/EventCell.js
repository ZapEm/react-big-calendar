...
var EventCell = _react2.default.createClass({
  ...
  render: function render() {
    ...
    var Event = _props.eventComponent;
    var EventWrapper = _props.eventWrapperComponent;

    var props = _objectWithoutProperties(_props, ['className', 'event', 'selected', 'eventPropGetter', 'startAccessor', 'endAccessor', 'titleAccessor', 'slotStart', 'slotEnd', 'onSelect', 'eventComponent', 'eventWrapperComponent']);
