    ...
    return events.map(function (event, idx) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'rbc-event-label', key: 'evt_lbl_' + idx },
            label
          ),
          _react2.default.createElement(
            'div',
            { className: 'rbc-event-content', key: 'evt_cnt_' + idx },
            EventComponent ? _react2.default.createElement(EventComponent, { event: event, title: title, key: 'evt_cmp_' + idx }) : title
          )
        )
      );
    });
